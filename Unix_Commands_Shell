...
## Sample Output: jithendra

3. hostname
## Purpose: Shows the system’s host name.
## Sample Output: server01

4. date
## Purpose: Shows current system date and time.
## Sample Output: Tue Jan 13 14:05:22 EST 2026

5. uptime
##Purpose: Shows how long the system has been running.
## Sample Output: 14:05:30 up 12 days, 4:32, 2 users, load average: 0.15, 0.10, 0.08
...
## Sample Output: /home/jithendra/projects
